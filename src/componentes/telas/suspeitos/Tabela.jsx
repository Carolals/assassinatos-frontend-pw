...
function Tabela() {
    ...
    return (
        <div style={{ padding: '20px' }}>
            <h1 style={{ color: 'red' }}>Suspeitos</h1>
                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Relação com a Vitima</th>
                        ...
                        <tbody>
                            {
                                listaObjetos.map(objeto => (
                                    <tr key={objeto.id}>
                                        ...
                                        <td>{objeto.nome}</td>
                                        <td>{objeto.idade}</td>
                                        <td>{objeto.genero ? 'Feminino' : "Masculino"}</td>
                                        <td>{objeto.relacaocomvitima}</td>
                    ...
                    <table className="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Idade</th>
                                <th scope="col">Genero</th>
                                <th scope="col">Relação com a Vítima</th>
                                <th scope="col">Assassinato ID</th>
                            </tr>
                        </thead>
                        <tbody>
